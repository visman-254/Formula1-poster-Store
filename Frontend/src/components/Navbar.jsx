...
/* ── Single source-of-truth breakpoint ── */
        ...
        return (
          <>
            ...
            <div className="nav-content">
              ...
              {/* ══════════════════════════════════
                  MOBILE NAV  (<820px)
                  Logo + all icons as siblings →
                  space-evenly across full width
              ══════════════════════════════════ */}
              {!isDesktop && (
                <div className="mobile-icons-row">
                  ...
                  <Link to="/home" className="mobile-icon-btn">
                    <img src={currentLogo} alt="logo" style={{ width: 40, height: "auto" }} />
                  </Link>
                  ...
                  <button
                    ...
                    aria-label="Search"
                  >
                    <Search className="h-5 w-5 text-gray-800 dark:text-white" />
                  </button>
                  ...
                  {/* Cart */}
                  <Link to="/cart" className="mobile-icon-btn relative">
                  ...
                  {user ? (
                    <DropdownMenu>
                      <DropdownMenuTrigger asChild>
                        <button className="mobile-icon-btn">
                          <div className="h-7 w-7 flex items-center justify-center rounded-full bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-white font-bold text-xs">
                            {user.username.charAt(0).toUpperCase()}
                          </div>
                        </button>
                      </DropdownMenuTrigger>
                    ...
                    <Link to="/login" className="mobile-icon-btn">
                      <User className="h-5 w-5 text-gray-800 dark:text-white" />
                    </Link>
                  )}

                  {/* Hamburger */}
                  <Disclosure.Button className="mobile-toggle" aria-label="Menu">
                    {open
              ...
              {open && !isDesktop && (
                <MobileDropdownPortal>
                  <div className="mobile-list">
                    <Link to="/home" className="mobile-link" onClick={() => handleMobileLinkClick(close)}>
                      Home
                    </Link>
                    <Link to="/preorder" className="mobile-link" onClick={() => handleMobileLinkClick(close)}>
                      Pre-order
                    </Link>
                    <div className="w-full">
                      ...
                      <Link to="/" className="mobile-link mobile-all-products" onClick={() => handleMobileLinkClick(close)}>
                        All Products
                      </Link>
