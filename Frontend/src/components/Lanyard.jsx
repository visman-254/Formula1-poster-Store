...
export default function Lanyard({ position = [0, 0, 30], gravity = [0, -40, 0], fov = 20, transparent = true }) {
 return (
  <Canvas
   ...
   camera={{ position, fov, near: 1, far: 2000 }}
  ...
  >
   ...
   <Environment preset="city">
    <Lightformer intensity={8} position={[10, 5, 0]} scale={[10, 5, 1]} onUpdate={self => self.lookAt(0, 0, 0)} />
   </Environment>
  </Canvas>
 );
}
  ...
  <>
   ...
   >
    ...
    <mesh castShadow receiveShadow geometry={nodes.card.geometry}>
     <meshStandardMaterial map={texture} map-anisotropy={16} transparent />
    </mesh>
   </RigidBody>
   <mesh ref={band}>
    <meshLineGeometry />
    <meshLineMaterial color="black" depthTest={false} lineWidth={1} transparent />
   </mesh>
  </>
 );
}