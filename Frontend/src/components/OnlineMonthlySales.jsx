...
const OnlineMonthlySales = () => {
  const [data, setData] = useState([]);
  const [loading, setLoading] = useState(true);

  useEffect(() => {
    axios.get(`${API_BASE}/api/order-type-analytics/online-monthly-sales`)
      .then(res => {
  ...
  return (
    <Card className="font-sans bg-glass">
      <CardHeader>
        <CardTitle>Online Monthly Sales</CardTitle>
      </CardHeader>
      <CardContent>
...
export default OnlineMonthlySales;