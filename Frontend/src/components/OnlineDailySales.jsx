...
const OnlineDailySales = () => {
  const [data, setData] = useState([]);
  const [loading, setLoading] = useState(true);

  useEffect(() => {
    axios.get(`${API_BASE}/api/order-type-analytics/online-daily-sales`)
      .then(res => {
  ...
  return (
    <Card className="font-sans bg-glass">
      <CardHeader>
        <CardTitle>Online Daily Sales</CardTitle>
      </CardHeader>
      <CardContent>
...
export default OnlineDailySales;